...
public class SignCert {
	...
	public static void main(String[] args) throws Exception {
		//从密钥库中读取CA的证书
		FileInputStream in = new FileInputStream("d:/ssl/openssl/client.p12");
		KeyStore ks = KeyStore.getInstance("PKCS12");
		ks.load(in, "123456".toCharArray());
		Certificate c1 = ks.getCertificate("1");
		System.out.println(c1.toString());

		//从密钥库中读取CA的私钥
		PrivateKey caprk = (PrivateKey) ks.getKey("1", "123456".toCharArray());
