...
//		client.setHostnameVerifier(new OkHttpClientTest().new NullHostNameVerifier());//忽略hostname的验证
	 ...
	 * 
	* @Title: init2 
	* @Description: 加载密钥库和信任库，初始化okhttpclient 
	* @param @throws Exception    入参
	* @return void    返回类型
	* @author masm 
	* @throws
...
//        keyStore.load(new FileInputStream(new File("F:/个人学习资料/ca-server01.p12")), "702187".toCharArray());
...
//                		"changeit".toCharArray(), new TrustSelfSignedStrategy())
                .loadTrustMaterial(new File("F:/个人学习资料/ca.jks"), "106075".toCharArray(),
                        new TrustSelfSignedStrategy())
//                .loadKeyMaterial(keyStore, "702187".toCharArray())
                .build();
